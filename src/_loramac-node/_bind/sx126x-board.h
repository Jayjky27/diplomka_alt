 ...
 */
#ifndef _SX126X_BOARD_H_
#define _SX126X_BOARD_H_

#include <stdint.h>
#include "sx126x.h"

/*!
 * \brief XCVR global init
 */
...
/*!
 * \brief XCVR power off
 */
void SX126xPwrOff(void);

/*!
 * \brief Initializes DIO IRQ callback
 *
 * \param [IN] IRQ callback function
 */
...
/*!
 * \brief Blocking loop to wait while the Busy pin is high
 */
